...
class MessagesController extends Controller
{
    ...
    {
        // Defina o baseUrl diretamente aqui
        //ChatifyMessenger::setBaseUrl(config('chatify.baseUrl'));
    }
    ...
    public function fetch(Request $request)
    {
        ...
        if ($totalMessages < 1) {
            $response['messages'] ='<p class="message-hint center-el"><span>Diga \'oi\' e comece a enviar mensagens</span></p>';
